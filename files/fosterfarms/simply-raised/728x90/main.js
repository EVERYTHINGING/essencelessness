...
function init() {  
    ...
    logo4 = document.querySelector(".logo-4");
...
function timeline() {
    ...
    setTimeout(function() {
        ...
        logoBgBig.className = "logo-bg-big hide-1";
        maskingGrass.className = "masking-grass hide-1";
    }, 1000);
    setTimeout(function() {
    ...
    setTimeout(function() {
        flag.className = "flag show left";
        logo.className = "logo left";
        maskingGrass2.className = "masking-grass-2 text-offset show left";
        chicken.className = "chicken chicken-jump-3 left";
    }, 11500);
    setTimeout(function() {
        flag.style.top = "26px";
        flag.src = "flag-2.png";
    ...
    setTimeout(function() {
        ...
        text4.className = "text-4 text-move";
