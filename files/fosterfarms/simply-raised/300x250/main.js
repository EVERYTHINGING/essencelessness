...
function timeline() {
    ...
    setTimeout(function() {
        ...
        // chicken.className = "chicken-2";
        // chicken.style.background = "url(chicken-2.png) no-repaet";
    }, 4100);
    ...
    setTimeout(function() {
        chicken.className = "chicken chicken-jump-1-1";
